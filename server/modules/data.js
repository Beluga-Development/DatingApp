...
const generateMatches = async (req) => {
  try {
    ...
    console.log("My gender:", myGender, "My sexuality:", mySexuality);
    console.log("My desired IDs:", myDesiredIds);
    console.log("All user skills:", allUserSkills);
    ...
    const scored = userDataIds
      .map(userDataId => {
        ...
        const theirSexuality = profile.Sexuality;
        ...
        const theyLikeMyGender =
          normalize(theirSexuality) === "Bisexual" || normalize(theirSexuality) === "Pansexual" ? true
          : normalize(theirSexuality) === "Heterosexual" ? theirGender !== myGender
          : normalize(theirSexuality) === "Homosexual" ? theirGender === myGender
          : false;
